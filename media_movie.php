...
<div class="wrapper">
	...
	<br><br>	
	<h2 class="aboutus_Headings">Your movie files</h2><br>
	<a href="media_movie.php">movie</a> &nbsp <a href="media_document.php">document</a> &nbsp <a href="media_photo.php">photo</a> &nbsp <a href="media_music.php">music.php</a>
	</div>
