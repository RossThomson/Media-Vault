...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$dbpass	= "root";
		...
		try {
					...
					{ 
						$sql = "INSERT INTO USERS(FIRSTNAME, LASTNAME, EMAIL, SECRETQUESTION, SECRETANSWERS, HASH, confirmcode) VALUES ('$firstname','$lastname','$email','$secretquestion','$secretanswer','$hash','$confirmcode')";
